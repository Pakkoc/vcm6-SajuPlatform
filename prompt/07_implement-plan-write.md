/docs/usecases/N-name/spec.md를 참조한다.

위 유스케이스 문서의 기능을 구현하기위한 최소한의 모듈화 설계 진행하세요.

1. /docs/{requirement,persona,prd,userflow,database,common-modules}.m, /docs/rules/tdd, /docs/external/\*.md 문서를 읽고 프로젝트의 상태를 구체적으로 파악한다.
